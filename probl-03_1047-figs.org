...
#+begin_src latex :noweb-ref output-box-scale
  [xscale=0.045, yscale=0.035, samples=128]
#+end_src
...
** COMMENT Frontera de posibilidades de producción
...
#+begin_src latex :tangle fig-03_1047-02b.tex
  \begin{tikzpicture}<<output-box-scale>>
    ...
    \node[dot, label={above:$T$}] at (65, 31.70732) {} ;
    \node[dot, label={below:$S$}] at (40, 14.28571) {} ;
    \node[dot, label={above:$U$}] at (20, 5.88235294) {} ;
    \node[dot, label={above:$V$}] at (80, 50) {} ;
...
#+begin_src latex :noweb-ref output-box-3
  % The box
  \draw[curve] (0,0) rectangle (100, 100);
  \node[left] at (7, -7) {$O_{A}$} ;
  \node[right] at (97, 105) {$O_{B}$} ;
  \node[below] at (75,-10) {Agua} ;
  \node[left] at (-10,75) {Pan} ;
  % \node[above] at (5,100) {$X_{B}$} ;
  % \node[right] at (100,5) {$Y_{B}$} ;
#+end_src

#+begin_src latex :tangle fig-03_1047-03a.tex
  \begin{tikzpicture}<<output-box-scale>>
    ...
    \draw[help lines] (50,0) node[below] {$50\%$} -- (50,100) ;

    \node[dot, label={above left:$Q$}] at (20.44104, 54.70359) {} ;
    \node[dot, label={above right:$S$}] at (50, 54.70359) {} ;
    \node[dot, label={below right:$T$}] at (50, 20) {} ;
    \draw[shift arrow, ->, shorten >= 4pt, shorten <= 4pt]
      (20.44104, 54.70359) -- (50, 54.70359) ;
...
** COMMENT Asignación ineficiente
...
** COMMENT Frontera de posibilidades de utilidad
...
** COMMENT Frontera de posibilidades de utilidad (II)
...
* COMMENT Eficiencia en la producción
...
* COMMENT Eficiencia en la combinación de productos
